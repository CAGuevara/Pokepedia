...
const Login = ({setUser}) => {
    //once the users clicks in submit we will mimic logging in and conditionally render our nav bar
    ...
    // we can use useNavigate from rr to redirect our users to different component page
    //do not forget / in navigate
